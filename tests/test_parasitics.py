...
def test_dummy_reduces_charge_injection() -> None:
    """Dummy switch should reduce total injected charge versus plain NMOS."""
    base = SwitchConfig(switch_type=SwitchType.NMOS)
    dummy = replace(base, switch_type=SwitchType.NMOS_DUMMY)
